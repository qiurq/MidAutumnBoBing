package com.banker.local_game.dice.adapter;
...
public class LocalGameListViewActivityAdapter extends BaseAdapter {
	
	private ArrayList<Item> mDiceBeanList;
	
	private Context mContext;
	
	public LocalGameListViewActivityAdapter(Context context) {
		mContext = context;
